...
public class ManagementService : BaseDAL, IManagementService
{
    private readonly IConfiguration _configuration;
    private readonly UserManager<ApplicationUser> _userManager;
    private readonly RoleManager<IdentityRole> _roleManager;

    public ManagementService(RoleManager<IdentityRole> roleManager, IConfiguration configuration, ILogger<AuthenticationService> logger, UserManager<ApplicationUser> userManager) : base(configuration, logger)
    {
